 ...
 */
@StateFactoryMarker fun mutableFloatStateOf(value: Float): MutableFloatState =
 ...
 */
@Stable
@JvmDefaultWithCompatibility interface FloatState : State<Float> {
 ...
 */
@Stable
@JvmDefaultWithCompatibility interface MutableFloatState : FloatState, MutableState<Float> {
  @get:AutoboxingStateValueProperty("floatValue")
...
internal fun createSnapshotMutableFloatState(value: Float): MutableFloatState =
