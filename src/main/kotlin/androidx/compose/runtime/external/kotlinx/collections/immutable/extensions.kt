 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentCollection<E>.plus(elements: Iterable<E>): PersistentCollection<E> = if (elements is Collection) addAll(elements) else builder().also { it.addAll(elements) }.build()
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentCollection<E>.plus(elements: Array<out E>): PersistentCollection<E> = builder().also { it.addAll(elements) }.build()
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentCollection<E>.plus(elements: Sequence<E>): PersistentCollection<E> = builder().also { it.addAll(elements) }.build()
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentCollection<E>.minus(elements: Iterable<E>): PersistentCollection<E> = if (elements is Collection) removeAll(elements) else builder().also { it.removeAll(elements) }.build()
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentCollection<E>.minus(elements: Array<out E>): PersistentCollection<E> = builder().also { it.removeAll(elements) }.build()
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentCollection<E>.minus(elements: Sequence<E>): PersistentCollection<E> = builder().also { it.removeAll(elements) }.build()
 ...
 */
internal operator fun <E> PersistentList<E>.plus(elements: Iterable<E>): PersistentList<E> = if (elements is Collection) addAll(elements) else mutate { it.addAll(elements) }
 ...
 */
internal operator fun <E> PersistentList<E>.plus(elements: Array<out E>): PersistentList<E> = mutate { it.addAll(elements) }
 ...
 */
internal operator fun <E> PersistentList<E>.plus(elements: Sequence<E>): PersistentList<E> = mutate { it.addAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentList<E>.minus(elements: Iterable<E>): PersistentList<E> = if (elements is Collection) removeAll(elements) else mutate { it.removeAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentList<E>.minus(elements: Array<out E>): PersistentList<E> = mutate { it.removeAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentList<E>.minus(elements: Sequence<E>): PersistentList<E> = mutate { it.removeAll(elements) }
 ...
 */
internal operator fun <E> PersistentSet<E>.plus(elements: Iterable<E>): PersistentSet<E> = if (elements is Collection) addAll(elements) else mutate { it.addAll(elements) }
 ...
 */
internal operator fun <E> PersistentSet<E>.plus(elements: Array<out E>): PersistentSet<E> = mutate { it.addAll(elements) }
 ...
 */
internal operator fun <E> PersistentSet<E>.plus(elements: Sequence<E>): PersistentSet<E> = mutate { it.addAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentSet<E>.minus(elements: Iterable<E>): PersistentSet<E> = if (elements is Collection) removeAll(elements) else mutate { it.removeAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentSet<E>.minus(elements: Array<out E>): PersistentSet<E> = mutate { it.removeAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <E> PersistentSet<E>.minus(elements: Sequence<E>): PersistentSet<E> = mutate { it.removeAll(elements) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal infix fun <E> PersistentSet<E>.intersect(elements: Iterable<E>): PersistentSet<E> = if (elements is Collection) retainAll(elements) else mutate { it.retainAll(elements) }
 ...
 * contained in the specified [elements] collection
 */
internal infix fun <E> PersistentCollection<E>.intersect(elements: Iterable<E>): PersistentSet<E> = this.toPersistentSet().intersect(elements)
 ...
 */
@Suppress("UNCHECKED_CAST")
internal inline operator fun <K, V> PersistentMap<out K, V>.plus(pair: Pair<K, V>): PersistentMap<K, V> = (this as PersistentMap<K, V>).put(pair.first, pair.second)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal fun <K, V> PersistentMap<out K, V>.putAll(pairs: Iterable<Pair<K, V>>): PersistentMap<K, V> = mutate { it.putAll(pairs) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal fun <K, V> PersistentMap<out K, V>.putAll(pairs: Array<out Pair<K, V>>): PersistentMap<K, V> = mutate { it.putAll(pairs) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal fun <K, V> PersistentMap<out K, V>.putAll(pairs: Sequence<Pair<K, V>>): PersistentMap<K, V> = mutate { it.putAll(pairs) }
 ...
 */
@Suppress("UNCHECKED_CAST")
internal operator fun <K, V> PersistentMap<out K, V>.minus(key: K): PersistentMap<K, V> = (this as PersistentMap<K, V>).remove(key)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <K, V> PersistentMap<out K, V>.minus(keys: Iterable<K>): PersistentMap<K, V> = mutate { it.minusAssign(keys) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <K, V> PersistentMap<out K, V>.minus(keys: Array<out K>): PersistentMap<K, V> = mutate { it.minusAssign(keys) }
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
internal operator fun <K, V> PersistentMap<out K, V>.minus(keys: Sequence<K>): PersistentMap<K, V> = mutate { it.minusAssign(keys) }
 ...
 * Order of the elements in the returned set is unspecified.
 */
internal fun <T> Iterable<T>.toPersistentHashSet(): PersistentSet<T> = this as? PersistentHashSet
 ...
 */
internal fun <K, V> Map<K, V>.toImmutableMap(): ImmutableMap<K, V> = this as? ImmutableMap
 ...
 * Entries of the returned map are iterated in the same order as in this map.
 */
internal fun <K, V> Map<K, V>.toPersistentMap(): PersistentMap<K, V> = this as? PersistentOrderedMap<K, V>
 ...
 * Order of the entries in the returned map is unspecified.
 */
internal fun <K, V> Map<K, V>.toPersistentHashMap(): PersistentMap<K, V> = this as? PersistentHashMap
